            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link to="#" className="text-sm text-muted-foreground hover:text-foreground">Testimonials</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link to="#" className="text-sm text-muted-foreground hover:text-foreground">Cookies</Link></li>
                </ul>
              </div>
            </div>
