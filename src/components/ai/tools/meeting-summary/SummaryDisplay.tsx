  ...
  return (
    <Card className="p-4 mt-4">
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-lg font-semibold">{t("meetingTools.meetingSummary")}</h3>
        <div className="flex space-x-2">
          ...
          >
            ...
            <span>{copied ? t("meetingTools.copied") : t("meetingTools.copy")}</span>
          </Button>
          ...
          >
            ...
            <span>{t("meetingTools.exportPdf")}</span>
          </Button>
          ...
          {audioData && (
            ...
            >
              ...
              <span>{t("meetingTools.downloadAudio")}</span>
            </Button>
          )}
        </div>
      </div>
