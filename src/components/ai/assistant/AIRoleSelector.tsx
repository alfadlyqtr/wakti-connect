...
export const AIRoleSelector: React.FC<AIRoleSelectorProps> = ({
  ...
  const roleDescriptions = {
    general: "Day planning, tasks, reminders",
    student: "Study help, research, assignments",
    work_creator: "Content creation, emails, writing",
    business_owner: "Business ops, staff, analytics"
  };
    ...
    >
      <TabsList className={`grid grid-cols-4 w-full ${compact ? 'px-1 py-0.5' : ''}`}>
        <TabsTrigger 
          ...
          title={roleDescriptions.general}
        >
        ...
        <TabsTrigger 
          value="student" 
          className="flex items-center gap-1 text-xs sm:text-sm"
          title={roleDescriptions.student}
        >
        ...
        <TabsTrigger 
          value="work_creator" 
          className="flex items-center gap-1 text-xs sm:text-sm"
          title={roleDescriptions.work_creator}
        >
        ...
        <TabsTrigger 
          ...
          className="flex items-center gap-1 text-xs sm:text-sm"
          title={roleDescriptions.business_owner}
        >
