        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Your all-in-one productivity and business management platform.
            </p>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-muted-foreground mb-2">West Bay, Doha, Qatar</p>
              <p className="text-muted-foreground mb-2">Email: info@wakti.qa</p>
              <p className="text-muted-foreground mb-2">Phone: +974 xxxx xxxx</p>
            </address>
          </div>
        </div>
